package co.jankins.psf.common.security;
...
public class JankerFilter implements Filter{
...
//			}
			...
			e.printStackTrace();
			logger.error( Logger.SECURITY_AUDIT,"Error in ESAPI security filter: " + e.getMessage(), e );
